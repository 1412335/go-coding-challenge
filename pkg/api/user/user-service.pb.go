...
var file_user_service_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0xfa, 0x09, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72,
	...
	0x7d, 0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x50,
	...
	0x31, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x3a, 0x01, 0x2a,
	0x12, 0x54, 0x0a, 0x06, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x12, 0x13, 0x2e, 0x75, 0x73, 0x65,
	...
	0x6f, 0x75, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x5c, 0x0a, 0x08, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x65, 0x12, 0x15, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	...
	0x65, 0x3a, 0x01, 0x2a, 0x42, 0x25, 0x5a, 0x07, 0x2e, 0x2f, 0x3b, 0x75, 0x73, 0x65, 0x72, 0x92,
	0x41, 0x19, 0x12, 0x13, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x20, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x32, 0x03, 0x31, 0x2e, 0x30, 0x2a, 0x02, 0x01, 0x02, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_user_service_proto_goTypes = []interface{}{
	...
	(*CreateAccountResponse)(nil),     // 23: user.CreateAccountResponse
	(*ListAccountsResponse)(nil),      // 24: user.ListAccountsResponse
	(*CreateTransactionResponse)(nil), // 25: user.CreateTransactionResponse
	(*ListTransactionsResponse)(nil),  // 26: user.ListTransactionsResponse
}
var file_user_service_proto_depIdxs = []int32{
	...
	9,  // 20: user.UserService.Login:input_type -> user.LoginRequest
	11, // 21: user.UserService.Logout:input_type -> user.LogoutRequest
	13, // 22: user.UserService.Validate:input_type -> user.ValidateRequest
	2,  // 23: user.UserService.Create:output_type -> user.CreateUserResponse
	8,  // 24: user.UserService.Delete:output_type -> user.DeleteUserResponse
	6,  // 25: user.UserService.Update:output_type -> user.UpdateUserResponse
	4,  // 26: user.UserService.List:output_type -> user.ListUsersResponse
	0,  // 27: user.UserService.ListStream:output_type -> user.User
	23, // 28: user.UserService.CreateAccount:output_type -> user.CreateAccountResponse
	24, // 29: user.UserService.ListAccounts:output_type -> user.ListAccountsResponse
	25, // 30: user.UserService.CreateTransaction:output_type -> user.CreateTransactionResponse
	26, // 31: user.UserService.ListTransactions:output_type -> user.ListTransactionsResponse
	10, // 32: user.UserService.Login:output_type -> user.LoginResponse
	12, // 33: user.UserService.Logout:output_type -> user.LogoutResponse
	14, // 34: user.UserService.Validate:output_type -> user.ValidateResponse
